...
$sql = mysqli_query($conf,'SELECT * FROM tbl_pemasukan
...
$pdf->CELL(25,6,'Kode Pemasukan',1,0,'C',1);
$pdf->CELL(25,6,'Kode Barang',1,0,'C',1);
$pdf->CELL(40,6,'Nama Barang',1,0,'C',1);
$pdf->CELL(40,6,'Tanggal Masuk',1,0,'C',1);
$pdf->CELL(35,6,'Jumlah Masuk',1,1,'C',1);
while($tampil = mysqli_fetch_array($sql)){
$pdf->SetX(25);
$pdf->setFillColor(255,255,255);
$pdf->CELL(8,6,$no,1,0,'C',1);
$pdf->CELL(25,6,$tampil['kode_pemasukan'],1,0,'L',1);
$pdf->CELL(25,6,$tampil['kode_barang'],1,0,'L',1);
$pdf->CELL(40,6,$tampil['nama_barang'],1,0,'L',1);
$pdf->CELL(40,6,$tampil['tanggal_masuk'],1,0,'L',1);
$pdf->CELL(35,6,$tampil['jumlah_masuk'],1,1,'L',1);
$no++;
}
$pdf->Output();
?>